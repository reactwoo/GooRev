...
<div class="wrap">
    ...
    <form method="post" action="">
        ...
        <!-- Google Review Link Settings Section -->
        <div class="grp-settings-section" style="background: #fff; border: 1px solid #ccd0d4; border-radius: 4px; padding: 20px; margin: 20px 0; box-shadow: 0 1px 1px rgba(0,0,0,.04);">
            <h2 style="margin-top: 0; padding-bottom: 10px; border-bottom: 1px solid #eee;"><?php esc_html_e('Google Review Link Settings', 'google-reviews-plugin'); ?></h2>
            <?php if ($is_connected && !empty($location_id)): ?>
                <table class="form-table">
                    <tbody>
                        <tr>
            ...
            <?php else: ?>
                <div class="notice notice-warning inline" style="margin: 0;">
                    <p>
                        <?php esc_html_e('Please connect your Google Business Profile in the', 'google-reviews-plugin'); ?>
                        <a href="<?php echo admin_url('admin.php?page=google-reviews-settings'); ?>"><?php esc_html_e('Settings page', 'google-reviews-plugin'); ?></a>
                        <?php esc_html_e('to automatically use your location\'s Place ID for review links.', 'google-reviews-plugin'); ?>
                    </p>
                </div>
            <?php endif; ?>
        </div>
