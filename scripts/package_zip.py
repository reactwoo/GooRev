#!/usr/bin/env python3
"""Release zip for ReactWoo Reviews. Paths: package.json → reactwooBuild."""
...
_DEFAULT_FOLDER = "reactwoo-reviews"

INCLUDE_DIRS = ["assets", "includes", "languages", "blocks"]

INCLUDE_FILES = [
    "reactwoo-reviews.php",
    "readme.txt",
    "uninstall.php",
    "license.txt",
    "index.php",
